...
| `reports/swing_machine_v0_1/provider_matched_attribution_contract_20260508T070500Z/huggingface_feature_outcome_attribution/feature_outcome_attribution_dataset.json` | Hugging Face contract-window row-level attribution dataset. | Current provider row dataset with coverage limitations | Yes, optional provider cross-check with explicit limitation. |
